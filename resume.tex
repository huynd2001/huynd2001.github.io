...
\hspace{10pt}\textbf{Uber Technologies Inc.} \hfill {\small June 2022 -- Aug 2022} \\
  \vspace{-2pt}
  \hspace{10pt}{\small \textit{Software Engineer Intern @ Data Security | \textcolor{gray}{Java, Python, SQL}}}
  % \begin{itemize}[leftmargin=31pt]
  % \vspace{-10pt}
  %   \setlength\itemsep{-5pt}
  %   \item {\small Data Security} 
...
\hspace{10pt}\textbf{Electronic Trading Challenge (ETC)} \hfill {\small 2022}
...
\hspace{10pt}\textbf{Rock Paper Scissor Agent} {\small | \textit{\textcolor{gray}{Haskell, Cabal, AngularJS}}} \hfill {\small \href{https://github.com/huynd2001/rps-player}{\faGithub{}/rps-player}}
  ...
  \vspace{-10pt}
    \setlength\itemsep{-5pt}
      ...
      \item {\small Developed back-end using Haskell Servant library to handle requests}
      \item {\small Developed front-end using AngularJS for receiving input from human players}
      \vspace{-5pt}
  \end{itemize}
...
\hspace{10pt}\textbf{YACHT Events Manager} {\small | \textit{\textcolor{gray}{Java, Dart, Flutter, AndroidSDK, Gradle}}} \hfill {\small \href{https://github.com/huynd2001/yacht}{\faGithub{}/yacht}}
  ...
  \vspace{-10pt}
    \setlength\itemsep{-5pt}
      ...
      \item {\small Designed an overlay using AngularJS allowing streamers to customize the appearance}
