...
\hspace{10pt}\textbf{Snowflake Inc.} \hfill {\small Sep 2022 -- Nov 2022} \\
  \vspace{-2pt}
  \hspace{10pt}{\small \textit{Software Engineer Intern @ Data Privacy | \textcolor{gray}{Java, C++}}}
...
\hspace{10pt}\textbf{Uber Technologies Inc.} \hfill {\small June 2022 -- Aug 2022} \\
  \vspace{-2pt}
  \hspace{10pt}{\small \textit{Software Engineer Intern @ Data Security | \textcolor{gray}{Java, Python, SQL, Hive, Spark, Presto}}}
  \begin{itemize}[leftmargin=31pt]
    \vspace{-10pt}
    \setlength\itemsep{-5pt}
...
\hspace{10pt}\textbf{YACHT Events Manager} {\small | \textit{\textcolor{gray}{Java, Dart, Flutter, AndroidSDK, Gradle}}} \hfill {\small \href{https://github.com/huynd2001/yacht}{\faGithub{}/yacht}}
  ...
  \vspace{-10pt}
    \setlength\itemsep{-5pt}
      ...
      \item {\small Utilized \textbf{Socket.IO} and DiscordJS to stream chats and filter inappropriate messages from multiple Discord channels}
      \vspace{-5pt}
  \end{itemize}
