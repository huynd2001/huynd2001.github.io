...
\hspace{10pt}\textbf{Databricks Inc.} \hfill {\small May 2023 - July 2023} \\
  ...
  \vspace{-10pt}
    ...
    \item {\small Developed and integrated user-defined tags for workspace CRUD operations and cloud resource provisioning using \textbf{Scala}}
...
\hspace{10pt}\textbf{Snowflake Inc.} \hfill {\small Sep 2022 -- Nov 2022} \\
  ...
  \begin{itemize}[leftmargin=31pt]
    ...
    \item {\small Reduced view creation time by \textbf{90\%} through JOIN queries optimization and analysis}
    \vspace{-7pt}
  \end{itemize}

\hspace{10pt}\textbf{Uber Technologies Inc.} \hfill {\small June 2022 -- Aug 2022} \\
  \vspace{-2pt}
  \hspace{10pt}{\small \textit{Software Engineer Intern @ Data Security \& Compliance | \textcolor{gray}{Java, Python, SQL, Hive, Spark, Presto}}}
  \begin{itemize}[leftmargin=31pt]
    \vspace{-10pt}
    \setlength\itemsep{-5pt}
